...
def tracert(dest_name_or_address):
    ...
    print(f"Try to trace route to {dest_name_or_address} ({dest_address}) with max hops {hops}:")
    ...
    while True:
        ...
        sys.stdout.write(f"{time_to_live}\t")
        ...
        if curr_address == dest_address or time_to_live > hops:
            exit(0)
